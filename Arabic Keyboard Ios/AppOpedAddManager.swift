  ...
  private func appOpenAdManagerAdDidComplete() {
    ...
    func loadAd() {
        if isLoadingAd || isAdAvailable() {
            ...
            GADAppOpenAd.load(withAdUnitID: "ca-app-pub-7873000489717472/1509733920", request: GADRequest()) { ad, error in
